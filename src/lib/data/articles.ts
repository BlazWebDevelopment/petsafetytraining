...
export const ARTICLES: Article[] = [
  ...
  a({
    ...
    excerpt:
      'A German Shepherd named Jackie lost his life trying to reach his owner during a chaotic police arrest Tuesday evening.',
    author: 'Staff Reporter',
    ...
    content: [
      ...
      'According to witnesses, officers were attempting to arrest 34-year-old Michael Turner following reports of a disturbance in a residential neighborhood. As officers placed Turner in custody, his German Shepherd, Jackie, became distressed and repeatedly tried to reach his owner.',
      'Witnesses described Jackie as barking loudly and pulling against a nearby fence before breaking free and running toward Turner. Officers reportedly attempted to stop the dog as he rushed toward the scene. During the confusion that followed, both Turner and Jackie suffered fatal injuries.',
      'Neighbors said Jackie had been Michael\'s constant companion for nearly seven years.',
      '"That dog loved him more than anything," said one resident. "All Jackie wanted was to get back to his owner. He didn\'t understand what was happening."',
      'Several witnesses became emotional while describing the dog\'s final moments. According to reports, Jackie continued trying to reach Turner even after being injured.',
      ...
      '"Run free, Jackie. You never stopped loving your best friend."',
    ],
  }),
  a({
    id: 'art_001',
